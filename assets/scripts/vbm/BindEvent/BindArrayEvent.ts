import ActionEvent, { Action } from "common/utility/ActionEvent";
...
export default class BindArrayEvent<T> {
    ...
    public BindObject(instance: T[]): T[] {
        ...
        newInstance.__itemsChanged__.addEvent(this.OnPropertyChangedFunc);
        return newInstance;
    }

    public UnbindObject(instance: T[]): void {
        if (instance && Object.hasProperty<OnBindArrayChangedEvent<T>>(instance, "__itemsChanged__")) {
            instance.__itemsChanged__.removeEvent(this.OnPropertyChangedFunc);
        }
    }
